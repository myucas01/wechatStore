...
Page({
  ...
  getAddressDetail() { // 获取详情放弃 添加新地址
    // let that = this;
    // let userInfo = wx.getStorageSync('userInfo');

    // util.request(api.AddressDetail + '?userType=' + userInfo.userType + '&companyId=' + userInfo.companyId + '&id=' + that.data.addressId)
    //   .then(function(res) {
    //     console.log(res)
    //     if (res.errno === 0) {
    //       if (res.data) {
